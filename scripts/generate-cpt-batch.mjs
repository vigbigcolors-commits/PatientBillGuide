...
function getCategory(code, descShort) {
  ...
  if (n >= 99304 && n <= 99310) return { category: 'Nursing facility', categorySlug: 'hospital-care' };
  if (n >= 99341 && n <= 99350) return { category: 'Home visits', categorySlug: 'office-visits' };
